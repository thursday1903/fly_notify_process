...
public class GsonUltilities {
	...
	static Gson gsonParse = new GsonBuilder().setDateFormat("yyyy/MM/dd HH:mm:ss").setLenient().disableHtmlEscaping()
			.create();
	...
	public static ArrayList<Object> fromJson(String jsonString, java.lang.reflect.Type t) {
		return gsonParse.fromJson(jsonString, t);
	}
}
